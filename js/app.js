(() => {
    ...
    (() => {
        ...
        const menuLinksWrappers = document.querySelectorAll("[data-hover-effect]");
        function hoverEffect() {
            menuLinksWrappers.forEach((menuLinksWrapper => {
                const menuLinks = menuLinksWrapper.querySelectorAll("a");
                const effectSpeed = menuLinksWrapper.dataset.lineEffect ? menuLinksWrapper.dataset.lineEffect : 400;
            ...
            function menuEffectItem(menuLinks, effectSpeed) {
                ...
                function menuLinkActions(e) {
                    ...
                    if (e.type === "mouseleave") {
                        ...
                        menuLinkItem.style.cssText = menuLinkPos > menuLinkHeight ? effectTop + effectTransition : effectBottom + effectTransition;
                    }
                }
            }
        }
        document.querySelectorAll("[data-magic-cursor]");
        ...
        let gotoblock_gotoBlock = (targetBlock, noHeader = false, speed = 500, offsetTop = 0) => {
            ...
            if (targetBlockElement) {
                ...
                FLS(`[gotoBlock]: Движения...едем к ${targetBlock}`);
        ...
        function rangeInit() {
            ...
            if (rangeItems.length) rangeItems.forEach((rangeItem => {
                ...
                item.noUiSlider.on("update", (function(values, handle) {
                    ...
                    if (handle) toValue.value = value; else fromValue.value = Math.round(value);
                }));
        ...
        function initSliders() {
            if (document.querySelector(".main-block__slider")) new core(".main-block__slider", {
                ...
                loop: true,
                navigation: {
                    prevEl: ".main-block__body .swiper-button-prev",
                    nextEl: ".main-block__body .swiper-button-next"
                }
            });
            if (document.querySelector(".body-new__slider")) new core(".body-new__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
                ...
                loop: true,
                navigation: {
                    prevEl: ".new__body .swiper-button-prev",
                    nextEl: ".new__body .swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1.6,
            ...
            if (document.querySelector(".body-manufacture__slider")) new core(".body-manufacture__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
                ...
                loop: true,
                navigation: {
                    prevEl: ".manufacture__body .swiper-button-prev",
                    nextEl: ".manufacture__body .swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 2,
            ...
            if (document.querySelector(".body-projects__slider")) new core(".body-projects__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
                ...
                loop: true,
                navigation: {
                    prevEl: ".projects__body .swiper-button-prev",
                    nextEl: ".projects__body .swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 2
            ...
            if (document.querySelector(".body-blog__slider")) new core(".body-blog__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
                ...
                loop: true,
                navigation: {
                    prevEl: ".blog__body .swiper-button-prev",
                    nextEl: ".blog__body .swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 2
            ...
            if (document.querySelector(".body-interiors__slider")) new core(".body-interiors__slider", {
                modules: [ Navigation, Parallax ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
                ...
                loop: true,
                navigation: {
                    prevEl: ".interiors__container .swiper-button-prev",
                    nextEl: ".interiors__container .swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1
            ...
            if (document.querySelector(".images-product")) {
                ...
                if (document.querySelector(".images-product")) new core(".images-product__slider", {
                    modules: [ Navigation, Thumb ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                    ...
                    navigation: {
                        prevEl: ".main-product__images .swiper-button-prev",
                        nextEl: ".main-product__images .swiper-button-next"
                    }
                });
            }
            if (document.querySelector(".slider-furniture__slider")) new core(".slider-furniture__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
                ...
                loop: true,
                navigation: {
                    prevEl: ".furniture__container .swiper-button-prev",
                    nextEl: ".furniture__container .swiper-button-next"
                }
            });
        }
        window.addEventListener("load", (function(e) {
        ...
        function documentActions(e) {
            const targetElement = e.target;
            if (targetElement.classList.contains("buttons-product__button_cart")) {
                const productId = targetElement.closest(".product__main").dataset.pid;
            ...
            if (targetElement.classList.contains("cart-header__icon") || targetElement.closest(".cart-header__icon")) {
                ...
                e.preventDefault();
            } else if (!targetElement.closest(".cart-header") && !targetElement.classList.contains("buttons-product__button_cart")) document.querySelector(".cart-header").classList.remove("_active");
        ...
        function addToCart(productButton, productId) {
            if (!productButton.classList.contains("_hold")) {
                ...
                const productImage = product.querySelector(".images-product__slide-ibg");
        ...
        const numbers = document.querySelectorAll(".pagging__item");
        let tabsContent = document.querySelectorAll("[data-tabs-body]>*");
        let currentStep = 0;
        const updateBtn = () => {
            if (currentStep === 4) {
        ...
        prevNext.forEach((button => {
            button.addEventListener("click", (e => {
                ...
                numbers.forEach(((number, numIndex) => {
                    number.classList.toggle("_active", numIndex === currentStep);
                    tabsContent.forEach(((tabsContentItem, numIndex) => {
                        tabsContentItem.setAttribute("data-tabs-item", "");
                        tabsContentItem.hidden = !numbers[numIndex].classList.contains("_active");
                    }));
                    updateBtn();
                }));
            }));
        ...
        document.addEventListener("click", (e => {
            if (e.target.closest("#startBtn")) {
                document.querySelector("._active").classList.remove("_active");
                numbers[0].classList.add("_active");
                currentStep = 0;
                numbers.forEach(((number, numIndex) => {
                    number.classList.toggle("_active", numIndex === currentStep);
                    tabsContent.forEach(((tabsContentItem, numIndex) => {
        ...
        document.addEventListener("click", (e => {
            if (e.target.closest("#endBtn")) {
                document.querySelector("._active").classList.remove("_active");
                numbers[4].classList.add("_active");
                currentStep = 4;
                numbers.forEach(((number, numIndex) => {
                    number.classList.toggle("_active", numIndex === currentStep);
                    tabsContent.forEach(((tabsContentItem, numIndex) => {
        ...
        da.init();
        document.addEventListener("click", script_documentActions);
        function script_documentActions(e) {
            const targetElement = e.target;
            const filtersBody = document.querySelector(".catalog__body");
            const iconFilterClose = document.querySelector(".icon-filter-close");
            if (targetElement.closest(".icon-filter-open")) {
                filtersBody?.classList.add("open-filters");
                iconFilterClose?.classList.add("active-icon");
                document.documentElement.classList.add("lock");
            } else if (!targetElement.closest(".catalog__body") && filtersBody?.classList.contains("open-filters")) {
                filtersBody?.classList.remove("open-filters");
                iconFilterClose?.classList.remove("active-icon");
                document.documentElement.classList.remove("lock");
            }
            if (targetElement.closest(".icon-filter-close")) {
                filtersBody?.classList.remove("open-filters");
                iconFilterClose?.classList.remove("active-icon");
                document.documentElement.classList.remove("lock");
            }
            ...
            } else if (!targetElement.closest(".menu__body") && MenuBody?.classList.contains("menu-open")) {
